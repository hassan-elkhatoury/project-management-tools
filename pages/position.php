...
<div class="col-lg-8">
    ...
    ?>
      <tr>
        ...
        <td style="text-transform:capitalize" class="text-center"><?php echo $row['daily_rate'].' MAD.' ?></td>
	...
	<form method="POST" id="pos_form">
		...
		<div class="form-horizontal">
			...
			<div class="col-sm-4"><label class="control-label" for="dr">Daily Rate:</label></div>
				<div class="col-sm-5">
					<input type="number" style="text-align:right" class="form-control input-sm" name="dr" id="dr" placeholder="MAD." required/>
				</div>
			</div>
		</div>	
		<hr style="border-bottom:1px solid grey"></hr>
